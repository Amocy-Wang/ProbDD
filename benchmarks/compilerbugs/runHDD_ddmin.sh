...
do
    ...
    timeout 10800 /hdd_ddmin/anaconda2/bin/picireny -i small.c --test r.sh --srcml:language C --grammar C.g4 --start compilationUnit --disable-cleanup > log_hdd_$target 2>&1
