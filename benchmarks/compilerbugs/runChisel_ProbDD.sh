...
do
    ...
    rm -f /benchmarks/compilerbugs/$i/chisel_ProbDD.out
    timeout 10800 /chisel_ProbDD/build/bin/chisel --skip_local_dep --skip_global_dep --skip_dce /benchmarks/compilerbugs/$i/r.sh /benchmarks/compilerbugs/$i/small.c >> /benchmarks/compilerbugs/$i/chisel_ProbDD.out
done
